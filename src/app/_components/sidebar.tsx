...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`${isOpen ? "min-w-72" : "min-w-24"} sticky top-0 flex h-screen flex-col justify-between bg-discord_left p-5 transition-transform`}
    >
      <div className="flex flex-col gap-4">
        ...
        >
          <Image
            ...
            priority
          />
          <p className={`text-lg ${isOpen ? "block" : "hidden"}`}>MC Company</p>{" "}
        </div>
